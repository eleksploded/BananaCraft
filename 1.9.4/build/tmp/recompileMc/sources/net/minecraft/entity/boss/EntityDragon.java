...
public class EntityDragon extends EntityLiving implements IEntityMultiPart, IMob
{
    ...
    private final Path pathFindQueue = new Path();
            ...
            else
            {
                ...
                if (this.worldObj.isRemote)
                {
                    if (this.newPosRotationIncrements > 0)
                    {
                        ...
                        double d2 = MathHelper.wrapAngleTo180_double(this.interpTargetYaw - (double)this.rotationYaw);
     ...
     *  
     * @param startIdx index into pathPoints of path start
     * @param finishIdx index into pathPoints of path end
     * @param andThen Optional first PathPoint node of a path to continue after reaching the destination.
     */
    public PathEntity findPath(int startIdx, int finishIdx, PathPoint andThen)
    {
        for (int i = 0; i < 24; ++i)
        {
     ...
     */
    private PathEntity makePath(PathPoint start, PathPoint finish)
    {
        int i = 1;
    ...
    public void onCrystalDestroyed(EntityEnderCrystal crystal, BlockPos pos, DamageSource dmgSrc)
    {
        ...
        {
            entityplayer = this.worldObj.func_184139_a(pos, 64.0D, 64.0D);
        }
