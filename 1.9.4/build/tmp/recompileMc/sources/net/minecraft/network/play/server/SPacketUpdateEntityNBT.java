...
public class SPacketUpdateEntityNBT implements Packet<INetHandlerPlayClient>
{
    ...
    private SPacketUpdateEntityNBT.Operation operation;
    ...
    public SPacketUpdateEntityNBT(SPacketUpdateEntityNBT.Operation operationIn, BossInfo data)
    {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        this.operation = (SPacketUpdateEntityNBT.Operation)buf.readEnumValue(SPacketUpdateEntityNBT.Operation.class);

        switch (this.operation)
        {
            case ADD:
                this.name = buf.readChatComponent();
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        {
            case ADD:
                buf.writeChatComponent(this.name);
    ...
    @SideOnly(Side.CLIENT)
    public SPacketUpdateEntityNBT.Operation getOperation()
    {
