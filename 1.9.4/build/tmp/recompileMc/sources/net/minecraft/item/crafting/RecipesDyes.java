...
public class RecipesDyes
{
    ...
    public void addRecipes(CraftingManager p_77607_1_)
    {
        for (int i = 0; i < 16; ++i)
        {
            p_77607_1_.addShapelessRecipe(new ItemStack(Blocks.wool, 1, i), new Object[] {new ItemStack(Items.dye, 1, 15 - i), new ItemStack(Item.getItemFromBlock(Blocks.wool))});
        ...
        p_77607_1_.addShapelessRecipe(new ItemStack(Items.dye, 1, EnumDyeColor.RED.getDyeDamage()), new Object[] {new ItemStack(Items.beetroot, 1)});
