...
public class RecipesCrafting
{
    ...
    public void addRecipes(CraftingManager p_77589_1_)
    {
        ...
        p_77589_1_.addShapelessRecipe(new ItemStack(Blocks.trapped_chest), new Object[] {Blocks.chest, Blocks.tripwire_hook});
        ...
        p_77589_1_.addRecipe(new ItemStack(Blocks.purpur_block, 4, 0), new Object[] {"FF", "FF", 'F', Items.chorus_fruit_popped});
        p_77589_1_.addRecipe(new ItemStack(Blocks.purpur_stairs, 4, 0), new Object[] {"#  ", "## ", "###", '#', Blocks.purpur_block});
        p_77589_1_.addRecipe(new ItemStack(Blocks.purpur_pillar, 1, 0), new Object[] {"#", "#", '#', Blocks.purpur_slab});
        p_77589_1_.addRecipe(new ItemStack(Blocks.end_bricks, 4, 0), new Object[] {"##", "##", '#', Blocks.end_stone});
    }
}