            ...
            label0:
            {
                ...
                if (this.getBold() == style.getBold() && this.getColor() == style.getColor() && this.getItalic() == style.getItalic() && this.getObfuscated() == style.getObfuscated() && this.getStrikethrough() == style.getStrikethrough() && this.getUnderlined() == style.getUnderlined())
                {
                    label85:
                    {
                        ...
                        {
                            if (!this.getChatClickEvent().equals(style.getChatClickEvent()))
                            {
                                break label85;
                            }
                        }
                        else if (style.getChatClickEvent() != null)
                        {
                            break label85;
                        }
                        ...
                        {
                            if (!this.getChatHoverEvent().equals(style.getChatHoverEvent()))
                            {
                                break label85;
                            }
                        }
                        else if (style.getChatHoverEvent() != null)
                        {
                            break label85;
                        }
