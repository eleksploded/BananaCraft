...
public class ChunkLoader
{
    ...
    public static void convertToAnvilFormat(ChunkLoader.AnvilConverterData p_76690_0_, NBTTagCompound compound, BiomeProvider p_76690_2_)
    {
        ...
        for (int l2 = 0; l2 < 16; ++l2)
        {
            for (int i3 = 0; i3 < 16; ++i3)
            {
                ...
                abyte[i3 << 4 | l2] = (byte)(BiomeGenBase.getIdForBiome(p_76690_2_.getBiomeGenerator(blockpos$mutableblockpos, Biomes.DEFAULT)) & 255);
            }
        }
