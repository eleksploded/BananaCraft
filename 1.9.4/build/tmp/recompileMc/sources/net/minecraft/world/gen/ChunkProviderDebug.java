...
public class ChunkProviderDebug implements IChunkGenerator
{
    ...
    protected static final IBlockState field_185934_a = Blocks.air.getDefaultState();
    protected static final IBlockState field_185935_b = Blocks.barrier.getDefaultState();
    ...
    public Chunk provideChunk(int x, int z)
    {
        ...
        for (int i = 0; i < 16; ++i)
        {
            for (int j = 0; j < 16; ++j)
            {
                int k = x * 16 + i;
                int l = z * 16 + j;
                chunkprimer.setBlockState(i, 60, j, field_185935_b);
