...
public abstract class StructureComponentTemplate extends StructureComponent
{
    ...
    {
        this.field_186177_b = field_186179_d.setIgnoreEntities(true).setReplacedBlock(Blocks.air);
    }
    ...
    {
        Rotation rotation = this.field_186177_b.getRotation();
        BlockPos blockpos = this.field_186176_a.transformedSize(rotation);
