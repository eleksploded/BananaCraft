...
public class StructureEndCityPieces
{
    ...
    private static final PlacementSettings field_186202_b = (new PlacementSettings()).setIgnoreEntities(true);
    private static final PlacementSettings field_186203_c = (new PlacementSettings()).setIgnoreEntities(true).setReplacedBlock(Blocks.air);
    private static final StructureEndCityPieces.IGenerator field_186204_d = new StructureEndCityPieces.IGenerator()
    {
        ...
        public boolean func_186185_a(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List<StructureComponent> p_186185_4_, Random p_186185_5_)
        {
            ...
            {
                Rotation rotation = p_186185_2_.field_186177_b.getRotation();
        ...
        public boolean func_186185_a(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List<StructureComponent> p_186185_4_, Random p_186185_5_)
        {
            ...
            if (structureendcitypieces$citytemplate1 != null)
            {
                for (Tuple<Rotation, BlockPos> tuple : StructureEndCityPieces.field_186205_e)
                {
                    ...
                    {
                        StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate2;
                        p_186185_4_.add(structureendcitypieces$citytemplate2 = StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate1, (BlockPos)tuple.getSecond(), "bridge_end", rotation.add((Rotation)tuple.getFirst()), true));
    ...
    private static final StructureEndCityPieces.IGenerator field_186207_g = new StructureEndCityPieces.IGenerator()
    {
        ...
        public boolean func_186185_a(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List<StructureComponent> p_186185_4_, Random p_186185_5_)
        {
            ...
            StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate1;
            p_186185_4_.add(structureendcitypieces$citytemplate1 = StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(4, j, 0), "bridge_end", rotation.add(Rotation.CLOCKWISE_180), true));
        ...
        public boolean func_186185_a(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List<StructureComponent> p_186185_4_, Random p_186185_5_)
        {
            ...
            for (int i = 0; i < 2 && p_186185_5_.nextInt(3) != 0; ++i)
            {
                ...
                for (Tuple<Rotation, BlockPos> tuple : StructureEndCityPieces.field_186208_h)
                {
                    ...
                    {
                        StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate1;
                        p_186185_4_.add(structureendcitypieces$citytemplate1 = StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate2, (BlockPos)tuple.getSecond(), "bridge_end", rotation.add((Rotation)tuple.getFirst()), true));
    ...
    public static class CityTemplate extends StructureComponentTemplate
        {
            ...
            public CityTemplate(String pieceNameIn, BlockPos pos, Rotation rot, boolean p_i46634_4_)
            {
                ...
                this.field_186182_e = rot;
                this.field_186183_f = p_i46634_4_;
                this.func_186180_a(pos);
            }
            ...
            private void func_186180_a(BlockPos p_186180_1_)
            {
                ...
                {
                    placementsettings = StructureEndCityPieces.field_186202_b.copy().setRotation(this.field_186182_e);
                }
                else
                {
                    placementsettings = StructureEndCityPieces.field_186203_c.copy().setRotation(this.field_186182_e);
                }
            ...
            protected void func_186175_a(String p_186175_1_, BlockPos p_186175_2_, World p_186175_3_, Random p_186175_4_, StructureBoundingBox p_186175_5_)
            {
                if (p_186175_1_.startsWith("Chest"))
                {
                    ...
                    if (p_186175_5_.isVecInside(blockpos))
                    {
                        ...
                        {
                            ((TileEntityChest)tileentity).setLoot(LootTableList.CHESTS_END_CITY_TREASURE, p_186175_4_.nextLong());
                        }
                    }
                }
                ...
                {
                    EntityItemFrame entityitemframe = new EntityItemFrame(p_186175_3_, p_186175_2_, this.field_186182_e.rotate(EnumFacing.SOUTH));
