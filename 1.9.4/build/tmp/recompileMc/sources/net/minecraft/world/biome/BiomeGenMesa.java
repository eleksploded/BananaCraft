...
{
    protected static final IBlockState field_185385_y = Blocks.dirt.getDefaultState().withProperty(BlockDirt.VARIANT, BlockDirt.DirtType.COARSE_DIRT);
    protected static final IBlockState field_185386_z = Blocks.grass.getDefaultState();
    protected static final IBlockState field_185381_A = Blocks.hardened_clay.getDefaultState();
    protected static final IBlockState field_185382_B = Blocks.stained_hardened_clay.getDefaultState();
    protected static final IBlockState field_185383_C = field_185382_B.withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE);
    protected static final IBlockState field_185384_D = Blocks.sand.getDefaultState().withProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND);
    ...
    public BiomeGenMesa(boolean p_i46704_1_, boolean p_i46704_2_, BiomeGenBase.BiomeProperties properties)
    {
        super(properties);
        this.field_150626_aH = p_i46704_1_;
        this.field_150620_aI = p_i46704_2_;
        this.spawnableCreatureList.clear();
        this.topBlock = field_185384_D;
        this.fillerBlock = field_185382_B;
                ...
                else if (iblockstate1.getBlock() == Blocks.stone)
                {
                    if (l == -1)
                    {
                        ...
                        if (i1 < l1 - 1)
                        {
                            ...
                            {
                                chunkPrimerIn.setBlockState(k1, i1, j1, field_185383_C);
                            }
                        }
                        else if (this.field_150620_aI && i1 > 86 + k * 2)
                        {
                            if (flag)
                            {
                                chunkPrimerIn.setBlockState(k1, i1, j1, field_185385_y);
                            }
                            else
                            {
                                chunkPrimerIn.setBlockState(k1, i1, j1, field_185386_z);
                            }
                        }
                        else if (i1 <= l1 + 3 + k)
                        {
                    ...
                    else if (l > 0)
                    {
                        ...
                        {
                            chunkPrimerIn.setBlockState(k1, i1, j1, this.func_180629_a(x, i1, z));
                        }
                    }
                }
            }
    ...
    public void func_150619_a(long p_150619_1_)
    {
        ...
        for (int i = 0; i < i2; ++i)
        {
            ...
            {
                this.field_150621_aC[k + l] = field_185382_B.withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW);
            }
        }
        ...
        for (int k2 = 0; k2 < j2; ++k2)
        {
            ...
            {
                this.field_150621_aC[l3 + i1] = field_185382_B.withProperty(BlockColored.COLOR, EnumDyeColor.BROWN);
            }
        }
        ...
        for (int j3 = 0; j3 < l2; ++j3)
        {
            ...
            {
                this.field_150621_aC[k4 + j1] = field_185382_B.withProperty(BlockColored.COLOR, EnumDyeColor.RED);
            }
        }
        ...
        for (int l4 = 0; l4 < k3; ++l4)
        {
            ...
            {
                this.field_150621_aC[j4 + k1] = field_185382_B.withProperty(BlockColored.COLOR, EnumDyeColor.WHITE);

                if (j4 + k1 > 1 && random.nextBoolean())
                {
                    this.field_150621_aC[j4 + k1 - 1] = field_185382_B.withProperty(BlockColored.COLOR, EnumDyeColor.SILVER);
                }
