...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public void func_175319_a(int p_175319_1_, String p_175319_2_)
    {
        ...
        ((GuiSlider)this.field_175349_r.func_178061_c(p_175319_1_ - 132 + 100)).setSliderValue(f1, false);
    ...
    private String func_175330_b(int p_175330_1_, float p_175330_2_)
    {
        switch (p_175330_1_)
        {
            ...
            case 162:
                ...
                else if ((int)p_175330_2_ >= BiomeGenBase.getIdForBiome(Biomes.hell))
                {
                    BiomeGenBase biomegenbase1 = BiomeGenBase.getBiomeForId((int)p_175330_2_ + 2);
                    return biomegenbase1 != null ? biomegenbase1.getBiomeName() : "?";
                }
                else
                {
                    BiomeGenBase biomegenbase = BiomeGenBase.getBiomeForId((int)p_175330_2_);
