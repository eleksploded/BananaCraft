...
public class GuiWorldEdit extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        guibutton.enabled = this.mc.getSaveLoader().getFile(this.field_184860_g, "icon.png").isFile();
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 3)
            {
                ...
                FileUtils.deleteQuietly(isaveformat1.getFile(this.field_184860_g, "icon.png"));
                button.enabled = false;
            }
            else if (button.id == 4)
            {
                ISaveFormat isaveformat2 = this.mc.getSaveLoader();
                OpenGlHelper.openFile(isaveformat2.getFile(this.field_184860_g, "icon.png").getParentFile());
            }
        }
    }
