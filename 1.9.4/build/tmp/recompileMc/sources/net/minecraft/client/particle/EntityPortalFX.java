...
public class EntityPortalFX extends EntityFX
{
    ...
    public void onUpdate()
    {
        ...
        float f1 = -f + f * f * 2.0F;
        float f2 = 1.0F - f1;
        this.posX = this.portalPosX + this.xSpeed * (double)f2;
        this.posY = this.portalPosY + this.ySpeed * (double)f2 + (double)(1.0F - f);
        this.posZ = this.portalPosZ + this.zSpeed * (double)f2;
