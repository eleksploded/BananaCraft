...
public class EntityAnimatedFX extends EntityFX
{
    ...
    public EntityAnimatedFX(World worldIn, double x, double y, double z, int textureIdxIn, int numFrames, float yAccelIn)
    {
        super(worldIn, x, y, z);
    ...
    public void onUpdate()
    {
        ...
        this.ySpeed += (double)this.yAccel;
        this.moveEntity(this.xSpeed, this.ySpeed, this.zSpeed);
        this.xSpeed *= 0.9100000262260437D;
        this.ySpeed *= 0.9100000262260437D;
        this.zSpeed *= 0.9100000262260437D;
