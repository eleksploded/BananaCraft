...
public class EffectRenderer
{
    ...
    private final Queue<EntityFX> queueEntityFX = Queues.<EntityFX>newArrayDeque();
    ...
    public void updateEffects()
    {
        ...
        if (!this.particleEmitters.isEmpty())
        {
            ...
            for (EntityParticleEmitter entityparticleemitter : this.particleEmitters)
            {
                ...
                if (!entityparticleemitter.isAlive())
                {
        ...
        {
            for (EntityFX entityfx = (EntityFX)this.queueEntityFX.poll(); entityfx != null; entityfx = (EntityFX)this.queueEntityFX.poll())
            {
