...
public class ArmorInit {
	public static ArmorMaterial ReinBananaArmor = EnumHelper.addArmorMaterial("ReinBananaArmor", 38, new int[] {5, 10, 8, 5}, 11);
	public static ArmorMaterial AwakenedBananaArmor = EnumHelper.addArmorMaterial("AwakenedBananaArmor", 39, new int[] {7, 12, 10, 7}, 22);
