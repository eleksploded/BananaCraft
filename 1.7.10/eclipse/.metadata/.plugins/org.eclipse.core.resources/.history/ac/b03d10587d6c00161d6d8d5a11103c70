...
public static void init(){
	...
	GameRegistry.addRecipe(new ItemStack(Tier1Items.ReinBanana), "OIO", "IBI", "OIO", 'O', new ItemStack(Blocks.stone), 'I', new ItemStack(Tier1Items.ReinBanana), 'B', new ItemStack(Items.iron_ingot));
