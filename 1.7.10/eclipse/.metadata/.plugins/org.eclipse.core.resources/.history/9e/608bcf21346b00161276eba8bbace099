...
public class Other{
	public static net.minecraft.item.Item MyProjectile_1 = new Projectile("BananaBomb").setCreativeTab(Reference.CreativeTab).setMaxStackSize(64); 
public static void init() {
	//Banana Life Core
	    ...
	    RenderingRegistry.registerEntityRenderingHandler(EntityProjectile.class, new RenderProjectile(MyProjectile_1));
	}
