...
public class Banana extends ItemFood implements IPlantable {
    String Texture;
    ...
    public Banana(int parHealAmount, float parSaturationModifier, 
            Block parBlockPlant, Block parSoilBlock, String unlocalName) {
    ...
    {
    par3List.add("You can plant this");
    par3List.add("This is suppose to not make Sense...");
    par3List.add("REALLY, you can mine this!");
    }
        @Override
