package com.pikachu923.BananaCraft.TileEntity;
...
public class TileIngotizer extends TileEntity implements ISidedInventory {
		...
		public void updateEntity() {
			...
			if (flag != this.furnaceBurnTime > 0) {
				flag1 = true;
				BananaIngotizer.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		...
		private boolean canSmelt() {
			if (this.furnaceItemStacks[0] == null) {
				...
				ItemStack itemstack = IngotizerRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
